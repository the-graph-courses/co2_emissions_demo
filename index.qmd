...
countries_to_select = ["Angola", "Cameroon", "Samoa", "Yemen", "Zambia"]
emissions_long_subset = emissions_long_1990_2022[
    emissions_long_1990_2022["country"].isin(countries_to_select)
].copy()
...
fig_chart = px.line(
    ...
    y="emissions",
    color="country",
    markers=True,  # optional: adds points on the line
