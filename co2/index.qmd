---
title: "Priscilla's Workshop Exercise: Emissions Data - Table, Map, and Chart"
format: html
---
...
table_df["absolute_change"] = emissions["2022"] - emissions["2000"]

# Calculate relative change as the absolute change divided by the 2000 emissions, then multiplied by 100
table_df["relative_change"] = table_df["absolute_change"] / table_df["2000"]
...
emissions_long = emissions.melt(id_vars=["country"],
                                var_name='year',
...
emissions_long_subset = emissions_long_1990_2022.query("country == 'China' | country == 'Switzerland' | country == 'Canada' | country == 'Brazil' | country == 'France'")
